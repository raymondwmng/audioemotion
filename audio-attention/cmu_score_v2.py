...
def PrintScore(score, epoch, K, lbl):
    ...
    print('Scoring -- Epoch [%d], Sample [%d], SUM MSE %.4f' % (epoch, K, score['MSE']))
    print('Scoring -- Epoch [%d], Sample [%d], AVG MSE %.4f' % (epoch, K, score['MSE']/K))
    ...
    print('Scoring -- Epoch [%d], Sample [%d], SUM MAE %.4f' % (epoch, K, score['MAE']))
    print('Scoring -- Epoch [%d], Sample [%d], AVG MAE %.4f' % (epoch, K, score['MAE']/K))
