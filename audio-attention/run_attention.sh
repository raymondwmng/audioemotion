...
for traindatalbl in ent05p2_t34v5t5_shoutclipped_fixlen501_mirrored ent05p2_t34v5t5_shoutclipped_fixlen501_constant ent05p2_t34v5t5_shoutclipped_fixlen401_mirrored ent05p2_t34v5t5_shoutclipped_fixlen401_constant ent05p2_t34v5t5_shoutclipped_fixlen301_mirrored ent05p2_t34v5t5_shoutclipped_fixlen301_constant ent05p2_t34v5t5_shoutclipped_fixlen201_mirrored ent05p2_t34v5t5_shoutclipped_fixlen201_constant 
#ent05p2_t34v5t5_shoutclipped #ravdess_t18v3t3_all1ne0caNA_shoutclipped iemocap_t1234t5_ne0frNAexNAotNA MOSEI_acl2018_multi MOSEI_acl2018_multi+ent05p2_t34v5t5_shoutclipped+ravdess_t18v3t3_all1ne0caNA_shoutclipped+iemocap_t1234t5_ne0frNAexNAotNA
...
#MOSEI_acl2018+ent05p2_t34v5t5_shoutclipped+ravdess_t18v3t3_all1ne0caNA_shoutclipped+iemocap_t1234t5_ne0frNAexNAotNA iemocap_t1234t5_ne0frNAexNAotNA
#ent05p2_t34v5t5_shoutclipped MOSEI_acl2018 ravdess_t18v3t3_shoutclipped iemocap_t1234t5 MOSEI_acl2018+ent05p2_t34v5t5_shoutclipped+ravdess_t18v3t3_all1ne0caNA_shoutclipped+iemocap_t1234t5_ne0frNAexNAotNA
do
...
do
  for ext in fbk #40 fbk60 fbk80 covarep plp mfcc
  do
    ...
    do
    for BATCHSIZE in 32 1 #64 128 256
    do

    for prev_epoch in 1 #`seq 1 10 $MAX_ITER`
    do
...
#	exit
      ...
      if [ "$testall" == "True" ]; then
        # test
        testdatalbl=MOSEI_acl2018+ent05p2_t34v5t5_shoutclipped+ravdess_t18v3t3_all1ne0caNA_shoutclipped+iemocap_t1234t5_ne0frNAexNAotNA+iemocap_t1234t5_ha+ex1sa1an1ne0
        scriptbase=$fpath/test${testdatalbl}${debug}
        L=${scriptbase}.log
        S=${scriptbase}.sh
        # create bash script
        echo "#!/usr/bin/bash" > $S
        echo "$python $wdir/test_attention.py -e $ext --train $traindatalbl --test $testdatalbl $debug" >> $S
        chmod u+x $S

        # submitjob
        jid=`$submitjob -q GPU -p MINI -o -l hostname="node21|node22|node23|node24|node25|node26" -eo -w $jid $L $S | tail -1`
        echo "$S $L $jid"
        echo "qdel $jid" >> ${killscript}
      fi
