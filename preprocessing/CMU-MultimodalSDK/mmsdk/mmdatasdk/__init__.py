...
from mmsdk.mmdatasdk.dataset.standard_datasets import CMU_MOSEI_TEXTONLY as cmu_mosei_textonly
from mmsdk.mmdatasdk.dataset.standard_datasets import CMU_MOSEI_AUDIOONLY as cmu_mosei_audioonly
